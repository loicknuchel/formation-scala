  ...
  describe("Defibrilators") {
    ...
    describe("getClosestDefibName") {
      ...
      it("should work with exemple") {
        ...
        )) shouldBe Success("Maison de la Prevention Sante")
      }
      it("should work with exact position") {
        getClosestDefibName(Point(3.88995587137398, 43.6260090150577), defibs) shouldBe Success("Cimetiere Saint-Etienne")
      }
      it("should work with complete file") {
        getClosestDefibName(Point(3.874054, 43.606779), defibs) shouldBe Success("Caisse Primaire d'Assurance Maladie")
      }
      it("should work with complete file 2") {
        getClosestDefibName(Point(3.833542, 43.634646), defibs) shouldBe Success("Amphitheatre d'O")
      }
    }
  }
}
